...
The system MUST compile and execute user-submitted Java solutions inside a hardened long-lived sandbox container runtime instead of directly on the host.
...
- **AND** sandbox runtime MUST compile and run the submitted code within container isolation
